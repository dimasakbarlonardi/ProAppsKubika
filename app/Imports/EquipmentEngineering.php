...
class EquipmentEngineering implements ToModel, WithStartRow
{
    ...
    public function model(array $row)
    {
        ...
        $connEquipment->no_equiqment = $row[1];
        $connEquipment->equiqment = $row[2];
        $connEquipment->id_room =  $this->Room($row[3]);
