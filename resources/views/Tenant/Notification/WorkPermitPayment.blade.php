        ...
        <div class="card-body">
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="fs--1"><a
                            href="mailto:{{ $transaction->WorkPermit->Ticket->Tenant->email_tenant }}">{{ $transaction->WorkPermit->Ticket->Tenant->email_tenant }}</a><br /><a
                            href="tel:444466667777">{{ $transaction->WorkPermit->Ticket->Tenant->no_telp_tenant }}</a>
                    </p>
                </div>
            ...
            @if ($transaction->transaction_status == 'PENDING')
                <form action="{{ route('generatePaymentPO', $transaction->WorkPermit->CashReceipt->id) }}" method="post"
                        ...
                        <div class="col-lg-8">
                            <div class="card h-100">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <p class="fs--1 mb-4">Pay with PayPal, Apple Pay, PayPal Credit and much
                                        more</p>
                                    ...
                                    <p class="fs--1 mb-4">Safe money transfer using your bank accounts. Visa,
                                        maestro,
                                        discover,
                                        american express.</p>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <p class="fs--1 text-600">Once you start your trial, you will have 30 days
                                        to use
                                        Falcon
                                        Premium for free. After 30 days you’ll be charged based on your selected
                                        plan.</p>
                                    ...
                                    <div class="text-center mt-2">
                                        <small class="d-inline-block">By continuing, you are
                                            agreeing to
                                            our subscriber <a href="#!">terms</a> and will be charged at
                                            the end of
                                            the
                                            trial.
                                        </small>
            ...
            @elseif ($transaction->transaction_status == 'VERIFYING')
                <div class="text-center">
                    ...
                    <a href="{{ route('paymentPO', [$transaction->CashReceipt->id]) }}" class="btn btn-success">Lihat
                        VA</a>
                </div>
            @endif
        </div>
    ...
    <script>
        ...
        $('document').ready(function() {
            ...
            var subtotal = parseInt(
                '{{ $transaction->WorkPermit->jumlah_deposit + $transaction->WorkPermit->jumlah_supervisi }}')
