    ...
    <div class="card-body">
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <p class="fs--1"><a href="mailto:{{ $transaction->WorkOrder->Ticket->Tenant->email_tenant }}">{{ $transaction->WorkOrder->Ticket->Tenant->email_tenant }}</a><br /><a href="tel:444466667777">{{ $transaction->WorkOrder->Ticket->Tenant->no_telp_tenant }}</a></p>
            </div>
