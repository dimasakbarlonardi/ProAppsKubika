    ...
    <div class="card">
        <div class="card-header bg-light py-2">
            <div class="row flex-between-center">
                <div class="col-auto">
                    <h6 class="mb-0">List Sub Menu</h6>
                </div>
                <div class="col-auto d-flex">
                    <a class="btn btn-primary" href="{{ route('create-sub-menu', $id) }}">Tambah Sub Menu</a>
                </div>
            </div>
        </div>
        <div class="p-5">
                        ...
                        <tbody class="list">
                            @foreach ($submenus as $menu)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('sub-menus-2.show', $menu->id) }}" class="btn btn-sm btn-primary">Submenu</a>
