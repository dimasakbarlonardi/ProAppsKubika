                ...
                <div class="row flex-between-center">
                    ...
                    <div class="col-auto d-flex">
                        <a class="btn btn-falcon-default btn-sm text-600"
                            href="{{ route('request-reservations.create') }}">Tambah Request</a>
                    </div>
                </div>
            </div>
            <div id="data-requests" class="table-responsive">
            </div>
        </div>
    </div>
    <div class="col-12 col-lg-3">
        <div class="offcanvas offcanvas-end offcanvas-filter-sidebar border-0 dark__bg-card-dark h-auto rounded-xl-3"
            ...
            <div class="offcanvas-header d-flex flex-between-center d-xl-none">
                ...
                <button class="btn-close text-reset d-xl-none shadow-none" type="button" data-bs-dismiss="offcanvas"
        ...
        <button class="btn btn-secondary d-xl-none mt-2" type="button" data-bs-toggle="offcanvas"
            data-bs-target="#ticketOffcanvas" aria-controls="ticketOffcanvas">Filter</button>
    </div>
</div>
@endsection
