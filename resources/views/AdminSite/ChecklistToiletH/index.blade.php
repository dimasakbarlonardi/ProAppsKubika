                        ...
                        <div class="d-lg-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                                ...
                                <div class="col-auto d-flex">
                                    <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('checklisttoilets.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Check list Toilet</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <form>
                                {{-- <div class="mb-3 mt-n2">
                                    <label class="mb-1">Tanggal Checklist Toilet</label>
                                    <select class="form-select form-select-sm" name="tgl_checklist" required id="tgl_checklist">
                                        @foreach ($checklisttoilets as $checklisttoilet)
                                            <option value="{{ $checklisttoilet->tgl_checklist }}"> {{ $checklisttoilet->tgl_checklist }}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                                <div class="mb-3 mt-n2">
                                    <label class="form-label" for="timepicker2">Tanggal Checklist Toilet</label>
                                ...
                                <div class="mb-3 mt-n2">
                                    <label class="mb-1">Nomer Checklist Toilet</label>
                                    <select class="form-select form-select-sm" name="no_checklist_toilet" required id="no_checklist_toilet">
                                        @foreach ($checklisttoilets as $checklisttoilet)
                                            <option value="{{ $checklisttoilet->no_checklist_toilet }}"> {{ $checklisttoilet->no_checklist_toilet }}</option>
                                        @endforeach
                                    </select>
                                </div>     
                                <div class="mb-3 mt-n2">
    ...
    <script>
        $('document').ready(function() {
            ...
            $('#no_checklist_toilet').on('change', function() {
                ...
                // console.log(tgl_checklist, no_checklist_toilet)
