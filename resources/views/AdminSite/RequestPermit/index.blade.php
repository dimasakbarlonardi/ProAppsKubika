                    ...
                    <div class="d-lg-flex justify-content-between">
                        <div class="row flex-between-center gy-2 px-x1">
                            <div class="col-auto pe-0">
                                <h6 class="mb-0">Request Permits</h6>
                            </div>
                            <div class="col-auto">
                                <form>
                        ...
                        <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                            ...
                            <div class="d-flex align-items-center" id="table-ticket-replace-element">
                                <a href="{{ route('request-permits.create') }}" class="btn btn-falcon-default btn-sm mx-2"
                                    type="button">
                                    <span class="fas fa-plus" data-fa-transform="shrink-3"></span>
                                    <span>
                                        Buat Request Permit Baru</span>
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-start align-items-sm-center">
                                    ...
                                    <div class="ms-1 ms-sm-3">
                                        <p class="fw-semi-bold mb-3 mb-sm-2">
                                            <a
                                                href="
                                            {{ route('request-permits.show', $permit->id) }}
                                            ">Work
                                                Permit
                                                #{{ $permit->no_request_permit }}</a>
                                        </p>
                                        <div class="d-flex justify-content-between">
                                            <div class="">
                                                <h5>{{ $permit->judul_request }}</h5>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-auto me-2">
                                                <h6 class="client mb-0">
                                                    <a class="text-800 d-flex align-items-center gap-1" href="">
                                                        ...
                                                        <span>{{ $permit->Ticket->Tenant->nama_tenant }}</span>
                                                    </a>
                                                </h6>
                                            </div>
                                            <div class="col-auto">
                                                <h6 class="mb-0 text-500">{{ TimeAgo($permit->created_at) }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between text-end">
                                    ...
                                    <div class="row text-right">
                                        <div class="">
                                            <span
                                                class="badge rounded-pill badge-subtle-primary">{{ $permit->JenisPekerjaan->jenis_pekerjaan }}</span>
                                            @switch($permit->status_request)
                                                @case('PENDING')
                                                    <span
                                                        class="badge rounded bg-warning red__bg-1000">{{ $permit->status_request }}</span>
                                                @break
