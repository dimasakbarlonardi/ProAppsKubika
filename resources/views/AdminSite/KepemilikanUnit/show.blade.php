        ...
        <div class="p-5">
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" value="{{$kepemilikans->id_status_hunian}}" class="form-control" readonly>
                        </div>
                        <div class="col-4 mb-3">
                ...
                <div class="mb-3" id="detail_unit" style="">
                    <div class="table-responsive scrollbar">
                        ...
                        {{-- <a href="{{ route('kepemilikans.edit', $kepemilikans->id_pemilik) }}" class="btn btn-sm btn-warning">Edit</a> --}}
