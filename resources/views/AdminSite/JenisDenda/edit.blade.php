        ...
        <div class="p-5">
            <form method="post" action="{{ route('jenisdendas.update', $jenisdenda->id_jenis_denda) }}">
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="jenis_denda" value="{{$jenisdenda->jenis_denda}}" class="form-control">
                </div>
                <div class="col-6">
                ...
                <div class="col-6" id="denda_flat_procetage">
                    ...
                    <div class="input-group mb-3"><input class="form-control" type="text" value="{{$jenisdenda->denda_flat_procetage}}" name="denda_flat_procetage" aria-describedby="basic-addon2" /><span class="input-group-text text-primary" id="basic-addon2">%</span></div>
                </div>
                <div class="col-6" id="denda_flat_amount">
                    <label class="form-label">Denda Flat Amount</label>
                    <div class="input-group mb-3"><input class="form-control" type="text" value="{{$jenisdenda->denda_flat_amount}}" name="denda_flat_amount" aria-describedby="basic-addon2" /><span class="input-group-text text-primary" id="basic-addon2">Rupiah</span></div>
                </div>
                </div>
                 </div>
                </div>
