    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('engahus.create') }}">Tambah Engeneering AHU</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($engahus as $key => $engahu)
                    <tr>
                        ...
                        <td>{{ $engahu->dsg }}</td>
                        <td>
                            <a href="{{ route('engahus.edit', $engahu->id_eng_ahu) }}" class="btn btn-sm btn-warning">Edit</a>
