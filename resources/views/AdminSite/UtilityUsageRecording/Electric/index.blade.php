                                ...
                                <div class="col-md-4">
                                    <div class="justify-content-end my-3">
                                        <div class="d-none ms-3" id="bulk-select-actions">
                                            <div class="d-md-flex">
                                                <select class="form-select form-select-sm mb-2 mb-md-0" aria-label="Bulk actions" id="valueAction">
                                                    @if (Request::session()->get('work_relation_id') == $approve->approval_1 && $user->Karyawan->is_can_approve != null)
                                                    <option class="can-select" value="approve" selected="selected">Approve</option>
                                                    @elseif (Request::session()->get('work_relation_id') == $approve->approval_2)
                                                    <option class="can-select" value="calculate">Calculate Invoice</option>
                                                    <option class="can-select" value="send">Send Invoice</option>
                                                    @else
                                                    <option disabled selected>No Action</option>
                                                    @endif
                                                </select>
                                                <button class="btn btn-falcon-success btn-sm ms-md-2" type="button" id="applyBulk">Apply</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <input class="form-control" name="nomor_listrik_awal" value="{{ $item->nomor_listrik_awal }}" type="integer" />
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="col-form-label" for="recipient-name">Current:</label>
                                                                <input class="form-control" name="nomor_listrik_akhir" value="{{ $item->nomor_listrik_akhir }}" type="integer" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <label class="col-form-label" for="recipient-name">Old
                                                                    previous:</label>
                                                                <input class="form-control" value="{{ $item->old_nomor_listrik_awal }}" disabled />
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="col-form-label" for="recipient-name">Old
                                                                    current:</label>
                                                                <input class="form-control" value="{{ $item->old_nomor_listrik_akhir }}" disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <label class="col-form-label" for="recipient-name">
                                                                    New
                                                                    previous:</label>
                                                                <input class="form-control" value="{{ $item->nomor_listrik_awal }}" disabled />
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="col-form-label" for="recipient-name">New
                                                                    current:</label>
                                                                <input class="form-control" value="{{ $item->nomor_listrik_akhir }}" disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
