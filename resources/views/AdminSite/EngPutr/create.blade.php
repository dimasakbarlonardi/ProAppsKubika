...
@section('content')
    <div class="card">
                ...
                <div class="col-auto">
                    <nav aria-label="breadcrumb">
                        <ol class="my-3 breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Engeneering Putr</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="p-5">
            <form method="post" action="{{ route('engputrs.store') }}">
                @csrf
                <div class="row">
                <div class="col-6">
                    <label class="form-label">Nama Engeneering Putr</label>
                    <input type="text" name="nama_eng_putr" class="form-control" required>
                </div>
                <div class="col-6">
