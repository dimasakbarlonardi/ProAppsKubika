    ...
    <div class="card">
        <div class="card-header py-2">
            <div class="row flex-between-center">
                <div class="col-auto">
                    <h6 class="my-3 text-white">Edit approve BAPP</h6>
                </div>
            </div>
        </div>
        <div class="p-5">
            <form method="post" action="{{ route('updateSystemApprove', $approve->id_approval_subject) }}">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" value="Tenant Terkait" disabled class="form-control">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Approve 2</label>
                            <input type="text" value="Divisi Bagian Terkait" disabled class="form-control">
                        </div>
                ...
                <div class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label class="form-label">Approve 4</label>
