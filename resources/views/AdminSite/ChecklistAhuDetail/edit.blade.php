            ...
            <form method="post" action="{{ route('ahudetails.update', $ahudetail->id_ahu) }}">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" name="no_checklist_ahu" value="{{ $ahudetail->no_checklist_ahu }}" class="form-control" required>
                    </div>
                    <div class=" col-6">
                    ...
                    <div class=" col-6">
                        ...
                        <input type="date" name="check_point" value="{{ $ahudetail->check_point }}" class="form-control" required>
                    </div>
                    <div class=" col-6">
                        <label class="form-label">Keterangan</label>
                        <input type="time" name="keterangan" value="{{ $ahudetail->keterangan }}" class="form-control" required>
                    </div>
                <div class="mt-5">
