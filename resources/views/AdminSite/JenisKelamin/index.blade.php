    ...
    <div class="card-header py-3">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('genders.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Jenis Kelamin</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($genders as $key => $gender)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('genders.edit', $gender->id_jenis_kelamin) }}" class="btn btn-sm btn-warning"><span class="fas fa-pencil-alt fs--2 me-1"></span>Edit</a>
