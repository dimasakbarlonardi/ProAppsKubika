    ...
    <div class="card">
        <div class="card-header py-2">
            <div class="row flex-between-center">
                <div class="col-auto">
                    <h6 class="my-3 text-light">Tambah Checklist Chiller Detail</h6>
                </div>
            </div>
        </div>
        <div class="p-5">
            <form method="post" action="{{ route('chillerdetails.store') }}">
                @csrf
                <div class="row">
                <div class="col-6">
                    <label class="form-label">Nomer Checklist Chiller</label>
                    <input type="text" name="no_checklist_chiller" class="form-control" required>
                </div>
                <div class=" col-6">
