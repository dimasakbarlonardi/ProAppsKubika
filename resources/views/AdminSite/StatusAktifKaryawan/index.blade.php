    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default text-600 btn-sm" href="{{ route('statusaktifkaryawans.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Status Aktif Karyawan</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($statusaktifkaryawans as $key => $statusaktifkaryawan)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('statusaktifkaryawans.edit', $statusaktifkaryawan->id_status_aktif_karyawan) }}" class="btn btn-sm btn-warning"><span class="fas fa-pencil-alt fs--2 me-1"></span>Edit</a>
