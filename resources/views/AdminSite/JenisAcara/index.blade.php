    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default text-600 btn-sm " href="{{ route('jenisacaras.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Jenis Acara</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($jenisacaras as $key => $jenisacara)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('jenisacaras.edit', $jenisacara->id_jenis_acara) }}" class="btn btn-sm btn-warning"><span class="fas fa-pencil-alt fs--2 me-1"></span>Edit</a>
