    ...
    <div class="card-header py-3">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('jeniskendaraans.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Jenis Kendaraan</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($jeniskendaraans as $key => $jeniskendaraan)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('jeniskendaraans.edit', $jeniskendaraan->id_jenis_kendaraan) }}" class="btn btn-sm btn-warning"><span class="fas fa-pencil-alt fs--2 me-1"></span>Edit</a>
