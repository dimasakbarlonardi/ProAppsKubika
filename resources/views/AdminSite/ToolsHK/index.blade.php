...
<div class="card">
    ...
    <div class="p-5 justify-content-center">
        <table class="table table-striped" id="table-toolshk">
            <thead>
                <tr>
                                        ...
                                        <div class="py-2">
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <form action="{{ route('returnHK.tool', ['id' => $tools->id]) }}" method="POST">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <button class="btn btn-warning btn-sm" type="submit">Return</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <a class="dropdown-item text-danger" href="#">
                                                <form action="{{ route('borrowHK.tool', ['id' => $tools->id]) }}" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <input class="form-control" type="number" name="borrow_qty" required>
                                                        </div>
                                                        <div class="col-4">
