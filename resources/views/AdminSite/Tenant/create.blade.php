            ...
            <div class="tenant">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" value="{{ old('no_telp_tenant') }}" maxlength="13" name="no_telp_tenant" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="penjamin mt-5" id="pasangan">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" value="{{ old('no_telp_penjamin') }}" maxlength="13" name="no_telp_penjamin" class="form-control">
                    </div>
                </div>
            </div>
