                ...
                <div class="card-header border-bottom border-200 px-0">
                    <div class="d-lg-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                            ...
                            <div class="d-md align-items-center" id="table-ticket-replace-element">
                                <button class="btn btn-falcon-default text-600 btn-sm mb-2 mr-md-2" type="button" data-bs-toggle="modal" data-bs-target="#modal-import-tenant">
                                    + Import Tenant
                                </button>
                                <a class="btn btn-falcon-default text-600 btn-sm mb-2 mr-md-2" href="{{ route('tenants.create') }}">Create Tenant</a>
                                <button class="btn btn-falcon-default text-600 btn-sm mb-2" type="button" data-bs-toggle="modal" data-bs-target="#modal-import-tenant-unit">
                                    + Import Tenant Unit
                                </button>
                            </div>
            ...
            <div class="offcanvas offcanvas-end offcanvas-filter-sidebar border-0 dark__bg-card-dark h-auto rounded-xl-3" tabindex="-1" id="ticketOffcanvas" aria-labelledby="ticketOffcanvasLabelCard">
                ...
                <div class="card scrollbar shadow-none shadow-show-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 mt-n2">
                            <label class="mb-1">Tenant Name</label>
                            <input type="text" class="form-control form-control-sm" id="search-tenant" placeholder="Search Tenant">
                        </div>

                    </div>
                </div>
            </div>
            <button class="btn btn-primary btn-sm d-xl-none mt-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#ticketOffcanvas" aria-controls="ticketOffcanvas">
                Filter
            </button>
        </div>
...
<script>
    ...
    $('#search-tenant').on('input', function() {
        var tower = $('#select-tower').val();
        var unit = $('#select-unit').val();
        var searchTenant = $(this).val();

        getData(tower, unit, searchTenant);
    });

    function getData(tower, unit, searchTenant) {
        $.ajax({
