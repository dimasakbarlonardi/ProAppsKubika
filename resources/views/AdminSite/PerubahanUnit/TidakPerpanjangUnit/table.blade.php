                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document"
                                        ...
                                        <div class="modal-content position-relative">
                                            <div class="position-absolute top-0 end-0 mt-2 me-2 z-index-1">
                                                <form
                                                    action="{{ route('deleteTenantUnit', $tenantunits->id_tenant_unit) }}"
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                                                    <h4 class="mb-1" id="modalExampleDemoLabel">Alasan Tidak Perpanjang
                                                        Unit</h4>
                                                </div>
                                                <div class="p-4 pb-0">
                                                    <form method="post" action="{{ route('offtenantunits.store') }}">
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="message-text">Tanggal
                                                                Keluar :</label>
