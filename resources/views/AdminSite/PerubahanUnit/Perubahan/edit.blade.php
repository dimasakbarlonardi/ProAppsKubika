            ...
            <form action="{{ route('updateTenantUnit', $tenantunit->id_tenant_unit) }}" method="post">
                ...
                <div class="row">
                    <div class="col-6 mb-3">
                        ...
                        <select class="form-control" name="id_pemilik" id="id_pemilik" required>
                            ...
                            @foreach ($owners as $owner)
                                <option value="{{ $owner->id_pemilik }}" {{ $owner->id_pemilik == $tenantunit->id_pemilik ? 'selected' : ''}}>{{ $owner->nama_pemilik }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-6 mb-3">
                        ...
                        <select class="form-control" name="id_unit" id="id_unit" required>
                            ...
                            @foreach ($getCreateUnits as $unit)
                                <option value="{{ $unit->id_unit }}"  {{ $unit->id_unit == $tenantunit->id_unit ? 'selected' : ''}}>
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <input type="text" value="{{ $tenantunit->id_periode_sewa }} " class="form-control" readonly>
                    </div>
                    <div class="col-4 mb-3">
                        <label class="form-label">Tanggal Masuk - Tanggal Keluar</label>
                        <input type="text" value="{{\Carbon\Carbon::parse($tenantunit->tgl_masuk)->format('d-M-Y')}} - {{\Carbon\Carbon::parse($tenantunit->tgl_keluar)->format('d-M-Y')}} " class="form-control" readonly>
                    </div>
                    <div class="col-4 mb-3">
                        <label class="form-label">Jatuh Tempo IPL</label>
                        <input type="text" value="{{\Carbon\Carbon::parse($tenantunit->tgl_jatuh_tempo_ipl)->format('d-M-Y')}}" class="form-control" readonly>
                    </div>
                    <div class="col-4 mb-3">
                        <label class="form-label">Jatuh Tempo UTIL</label>
                        <input type="text" value="{{\Carbon\Carbon::parse($tenantunit->tgl_jatuh_tempo_util)->format('d-M-Y')}}" class="form-control" readonly>
                    </div>
                </div>
            </div>
