    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('checklistahus.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Equipment Engineering </a>
            </div>
        </div>
    </div>
    <div class="p-5">
        ...
        <table class="table" id="table-engineering">
            ...
            <tbody id="checklist_body">
                ...
                <tr>
                    ...
                    <td>{{ $checklistahu->Room->Tower->nama_tower }} - {{ $checklistahu->Room->Floor->nama_lantai }} - {{ $checklistahu->Room->nama_room }}</td>
                    <td>
                        <div class="dropdown font-sans-serif position-static">
                            ...
                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                <div class="py-2">
                                    <a class="dropdown-item text" href="{{ route('checklistengineering', $checklistahu->id_equiqment_engineering) }}">Inspection
                                        Parameter
                                    </a>
                                    <a class="dropdown-item text" href="{{ route('inspectionSchedules', $checklistahu->id_equiqment_engineering) }}">
                                        Schedules
                                    </a>
                                    <a class="dropdown-item text" href="{{ route('checklistahus.edit', $checklistahu->id_equiqment_engineering) }}">
                                        Edit Equipment
                                    </a>
                                </div>
                            </div>
