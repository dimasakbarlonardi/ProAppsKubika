                ...
                <div class="row flex-between-center">
                    ...
                    <div class="col-auto d-flex">
                        <a class="btn btn-falcon-default btn-sm text-600"
                            href="{{ url('/import_template/template_schedule_inspection_engineering.xlsx') }}" download>
    ...
    <div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
            <div class="modal-content position-relative">
                ...
                <form action="{{ route('importSchedulesEngineering') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body p-0">
                    ...
                    <input type="hidden" name="id_equipment_engineering" value="{{ $eq->id_equiqment_engineering }}">
