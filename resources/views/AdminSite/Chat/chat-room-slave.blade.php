@if ($room)
    <div class="chat-content-scroll-area scrollbar" id="content-message-body">
                    ...
                    <div class="flex-1 d-flex justify-content-end">
                        <div class="w-100 w-xxl-75">
                            ...
                            <div class="text-400 fs--2 text-end">
                                {{ HumanDateTime($chat->created_at) }}<span
    ...
    <input type="hidden" id="receiver_id_value" value="{{ $room->Receiver->id_user }}">
@endif
