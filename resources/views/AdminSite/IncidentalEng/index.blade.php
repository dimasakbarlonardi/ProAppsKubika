    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default text-600 btn-sm" href="{{ route('incidentalreporteng.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Incident Report</a>
            </div>
        </div>
    </div>
    <div class="p-5 justify-content-center">
        <table class="table" id="table-incidenteng">
            ...
            <tbody id="checklist_body">
                @foreach ($incidentalengs as $key => $incident)
                    <tr>
        ...
        <div class="modal fade" id="error-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
              <div class="modal-content position-relative">
                ...
                <img id="modal-image" src="{{ $incident->image ? asset($incident->image) : asset('/assets/img/team/3-thumb.png') }}" alt="{{ $incident->image }}" class="img-thumbnail">
...
@section('script')
    ...
    <script>
        new DataTable('#table-incidenteng');
    </script>
    <script>
