    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ url('/import_template/tamplate_housekeeping_parameter.xlsx') }}" download>
                ...
                <a class="btn btn-falcon-default btn-sm text-600 ml-3" href="{{ route('housekeeping.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create Parameter
                </a>
            </div>
...
<div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
        <div class="modal-content position-relative">
            ...
            <form action="{{ route('importHKParameter') }}" method="post" enctype="multipart/form-data">
                @csrf
