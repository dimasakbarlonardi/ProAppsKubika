                                ...
                                <div class="d-flex align-items-start align-items-sm-center">
                                    ...
                                    <div class="ms-1 ms-sm-3">
                                        <p class="fw-semi-bold mb-3 mb-sm-2">
                                            <a href="{{ route('work-orders.show', $wo->id) }}">Work Orders
                                                #{{ $wo->no_work_order }}</a>
                                        </p>
                                            ...
                                            <div class="col-auto me-2">
                                                <h6 class="client mb-0">
                                                    <a class="text-800 d-flex align-items-center gap-1" href="">
                                                        <span class="fas fa-user" data-fa-transform="shrink-3 up-1">
                                                        </span>
                                                        <span>{{ $wo->Ticket->Tenant->nama_tenant }}</span>
                                                    </a>
                                                </h6>
                                            </div>
                                            <div class="col-auto">
                                                <h6 class="mb-0 text-500">{{ TimeAgo($wo->created_at) }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
