            ...
            <div class="card-body">
                <div class="request">
                    <div class="d-md-flex d-xl-inline-block d-xxl-flex align-items-center justify-content-between mb-x1">
                        <div class="d-flex align-items-center gap-2">
                            <div class="avatar avatar-2xl">
                                <img class="rounded-circle" src="{{ $ticket->Tenant->User->profile_picture ? url($ticket->Tenant->User->profile_picture) : '' }}" alt="" />
                            </div>
                            <p class="mb-0"><a class="fw-semi-bold mb-0 text-800" href="../../app/support-desk/contact-details.html">{{ $ticket->Tenant->User->nama_user }}</a>
                                <a class="mb-0 fs--1 d-block text-500" href="mailto:emma@watson.com">{{ $ticket->Tenant->User->login_user }}</a>
                            </p>
                        </div>
                        ...
                        <div class="px-x1 py-3 bg-light">
                            <div class="d-inline-flex flex-column">
                                <div class="border p-2 rounded-3 d-flex bg-white dark__bg-1000 fs--1 mb-2">
                                    <a class="ms-auto text-decoration-none" target="_blank" href="{{ url($ticket->upload_image) }}">
                    ...
                    <div class="card-footer text-end" id="preview-footer">
                        <button class="btn btn-falcon-default btn-sm fs--1" type="button" onclick="onReply()" id="btnReply">
                ...
                <div class="my-5 position-relative text-center">
                    ...
                    <span class="position-relative bg-white dark__bg-card-dark px-3 z-index-1">
                        <button class="btn btn-sm btn-outline-secondary rounded-pill border-300 px-lg-5">Reply</button>
                    </span>
                </div>
                <div class="d-md-flex d-xl-inline-block d-xxl-flex align-items-center justify-content-between mb-x1">
                    <p class="mb-0 fs--2 fs-sm--1 fw-semi-bold mt-2 mt-md-0 mt-xl-2 mt-xxl-0 ms-5">
...
>>>>>>> 121ce1783c6cc67a462a61f7a57989a5523bdd61
                ...
                <div class="card-body">
                    <div class="mb-2 mt-n2"><label class="mb-1">Jenis Request</label>
                        <select name="id_jenis_request" class="form-select form-select-sm" {{ $ticket->status_request != 'RESPONDED' ? 'disabled' : '' }}>
                            <option disabled selected>--Pilih Jenis Request---</option>
                            @foreach ($jenis_requests as $request)
                    ...
                    $ticket->status_request != 'COMPLETE')
                    <div class="mb-2"><label class="mb-1 mt-2">Status</label>
                        <select name="status_request" class="form-select form-select-sm" {{ $ticket->status_request != 'RESPONDED' ? 'disabled' : '' }}>
                            <option disabled selected>--Pilih Status---</option>
                            <option {{ $ticket->status_request == 'PROSES KE WR' ? 'selected' : '' }} value="PROSES KE WR">Proses ke WR</option>
                            <option {{ $ticket->status_request == 'PROSES KE PERMIT' ? 'selected' : '' }} value="PROSES KE PERMIT">Proses ke Permit</option>
                            <option {{ $ticket->status_request == 'PROSES KE RESERVASI' ? 'selected' : '' }} value="PROSES KE RESERVASI">Proses ke Reservasi</option>
                            <option {{ $ticket->status_request == 'PROSES KE GIGO' ? 'selected' : '' }} value="PROSES KE GIGO">Proses ke GIGO</option>
                            <option {{ $ticket->status_request == 'DONE' ? 'selected' : '' }} value="DONE">
                                DONE</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="mb-2"><label class="mb-1 mt-2">Status</label>
                            <input type="text" value="{{ $ticket->status_request }}" class="form-control" disabled>
                        </div>
                        @endif
                    </div>
                    @if ($ticket->status_request == 'RESPONDED')
            ...
            <div class="card-body">
                <div class="row g-0 border-bottom pb-x1 mb-x1 align-items-sm-center align-items-xl-start">
                    ...
                    <div class="col-12 col-sm-auto col-xl-12">
                        <p class="fw-semi-bold text-800 mb-0">{{ $ticket->Tenant->User->nama_user }}</p><a class="btn btn-link btn-sm p-0 fe-medium fs--1" href="#">View more
                            details</a>
                    </div>
                </div>
                    ...
                    <div class="col-auto col-md-6 col-lg-auto">
                        <div class="row">
                            <div class="col-md-auto mb-4 mb-md-0 mb-xl-4">
                                <h6 class="mb-1">Email</h6><a class="fs--1" href="mailto:mattrogers@gmail.com">{{ $ticket->Tenant->User->login_user }}</a>
                            </div>
                            <div class="col-md-auto mb-4 mb-md-0 mb-xl-4">
                        ...
                        <div class="row">
                            <div class="col-md-auto mb-4 mb-md-0 mb-xl-4">
                                <h6 class="mb-1">Unit</h6><a class="fs--1" href="mailto:mattrogers@gmail.com">Lantai :
