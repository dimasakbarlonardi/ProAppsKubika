        ...
        <form method="post" action="{{ route('open-tickets.store') }}" enctype="multipart/form-data" id="create-open-request">
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input id="judul_request" type="text" maxlength="50" value="{{ old('judul_request') }}" name="judul_request" class="form-control" required>
                </div>
                <!-- <div class="mb-3"> -->
                <div class="col-6">
                    <label class="form-label">No HP</label>
                    <input type="text" value="{{ old('no_hp') }}" maxlength="13" id="no_hp" name="no_hp" class="form-control" required>
                </div>
