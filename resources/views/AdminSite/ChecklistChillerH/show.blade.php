                    ...
                    <body>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>: {{\Carbon\Carbon::parse($checklistchiller->tgl_checklist)->format(' d M Y') }} - {{\Carbon\Carbon::createFromFormat('H:i:s',$checklistchiller->time_checklist)->format('h:i')}}</td>
                                <th><b>Room </b></th>
                                <td>: {{ $checklistchiller->room->nama_room }}</td>
                            </tr>
                            <tr>
                                <th><b>Equiqment </b></th>
                                <td>: {{$checklistchiller->equiqment->equiqment}}</td>
                              <th><b>PIC </b></th>
                                <td>: {{ $checklistchiller->role->nama_role}}</td>
                            </tr>
                        </table>
                      </body>
                          ...
                          <table class="table table-bordered table-striped fs--1 mb-0">
                            ...
                            <tbody class="list">
                              <tr>
                                ...
                                <td class="usage_return">{{\Carbon\Carbon::parse($chillerdetail->usage_return)->format(' d M Y') }}</td>
