                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_card_type" id="id_card_type" required
                                    disabled>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" maxlength="16" name="nik_karyawan"
                                    value="{{ $karyawan->nik_karyawan }}" class="form-control editable" disabled>
                            </div>
                            <div class="col-6">
                                <label class="form-label">Domicile</label>
                                <input type="text" name="alamat_ktp_karyawan"
                                    value="{{ $karyawan->alamat_ktp_karyawan }}" class="form-control editable" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="no_telp_karyawan" value="{{ $karyawan->no_telp_karyawan }}"
                                    disabled class="form-control editable">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="date" name="tgl_masuk" value="{{ $karyawan->tgl_masuk }}" disabled
                                    class="form-control editable">
                            </div>
                            <div class="col-6">
                                <label class="form-label">Resign Date</label>
                                <input type="date" name="tgl_keluar" value="{{ $karyawan->tgl_keluar }}" disabled
                                    class="form-control editable">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_departemen" id="id_departemen" required
                                    disabled>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_jabatan" id="id_jabatan" required
                                    disabled>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_penempatan" id="id_penempatan" required
                                    disabled>
                                    <option selected disabled>-- Pilih Status --</option>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_jenis_kelamin" id="id_jenis_kelamin"
                                    required disabled>
                                    <option selected disabled>-- Pilih Penempatan --</option>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="id_status_kawin" id="id_status_kawin"
                                    required disabled>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control editable" name="is_can_approve" id="is_can_approve" required
                                    disabled>
                                    <option selected disabled>-- Pilih Status --</option>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="nama_pasangan_penjamin"
                                        value="{{ $karyawan->nama_pasangan_penjamin }}" class="form-control editable"
                                        disabled>
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Domicile</label>
                                    <input type="text" name="alamat_ktp_pasangan_penjamin"
                                        value="{{ $karyawan->alamat_ktp_pasangan_penjamin }}"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="hubungan_penjamin"
                                        value="{{ $karyawan->hubungan_penjamin }}" class="form-control editable"
                                        disabled>
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Call Number</label>
                                    <input type="text" name="no_telp_penjamin"
                                        value="{{ $karyawan->no_telp_penjamin }}" class="form-control editable" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
