                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" name="id_departemen" required>
                                    ...
                                    @foreach ($departemens as $departemen)
                                        <option value="{{ $departemen->id_departemen }}" @if(old('id_departemen') == $departemen->id_departemen) selected @endif>{{ $departemen->nama_departemen }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" name="id_divisi" required>
                                    ...
                                    @foreach ($divisis as $divisi)
                                        <option value="{{ $divisi->id_divisi }}" @if(old('id_divisi') == $divisi->id_divisi) selected @endif>{{ $divisi->nama_divisi }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select class="form-control" name="id_jabatan" required>
                                    ...
                                    @foreach ($jabatans as $jabatan)
                                        <option value="{{ $jabatan->id_jabatan }}" @if(old('id_jabatan') == $jabatan->id_jabatan) selected @endif>{{ $jabatan->nama_jabatan }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" name="id_penempatan" required>
                                    ...
                                    @foreach ($penempatans as $penempatan)
                                        <option value="{{ $penempatan->id_penempatan }}" @if(old('id_penempatan') == $penempatan->id_penempatan) selected @endif>{{ $penempatan->lokasi_penempatan }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
