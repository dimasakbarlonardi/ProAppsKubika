    ...
    <div class="card-header py-2">
        <div class="row flex-between-center">
            ...
            <div class="col-auto d-flex">
                <a class="btn btn-falcon-default btn-sm text-600" href="{{ route('idcards.create') }}"><span class="fas fa-plus fs--2 me-1"></span>Create ID Card</a>
            </div>
        </div>
    </div>
    <div class="p-5">
            ...
            <tbody>
                @foreach ($idcards as $key => $idcard)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('idcards.edit', $idcard->id_card_type) }}" class="btn btn-sm btn-warning"><span class="fas fa-pencil-alt fs--2 me-1"></span>Edit</a>
