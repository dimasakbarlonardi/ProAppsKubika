                            ...
                            <div class="card-body" style="background-color: #E9F7F5;">
                                <div class="row flex-between-center g-0">
                                    <div class="col-6 d-lg-block flex-between-center">
                                        <h6 class="mb-2 text-900">Request Complete</h6>
                                        <h4 class="fs-3 fw-normal text-700 mb-0">
                                    ...
                                    <div class="col-auto h-100">
                                        <img height="45" src="{{ asset('assets/img/icons/ticket_complete.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-3 col-lg-3 mb-4">
                        <div class="card text-white ">
                            <div class="card-body" style="background-color: #BEE8E1;">
                                <div class="row flex-between-center g-0">
                                    <div class="col-6 d-lg-block flex-between-center">
                                        <h6 class="mb-2 text-900">Request on Progress</h6>
                                        <h4 class="fs-3 fw-normal text-700 mb-0">
                                    ...
                                    <div class="col-auto h-100">
                                        <img height="45" src="{{ asset('assets/img/icons/ticket_on_progress.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-3 col-lg-3 mb-4">
                        <div class="card text-white ">
                            <div class="card-body" style="background-color: #E9F7F5;">
                                <div class="row flex-between-center g-0">
                                    <div class="col-6 d-lg-block flex-between-center">
                                        <h6 class="mb-2 text-900">Request Hold</h6>
                                        <h4 class="fs-3 fw-normal text-700 mb-0">
                                            <span>0</span>
                                            <span>/</span>
                                            <span>{{ $entry_ticket }}</span>
                    ...
                    <div class="col-3 col-lg-3 mb-4">
                        <div class="card text-white ">
                            <div class="card-body" style="background-color: #BEE8E1;">
                                <div class="row flex-between-center g-0">
                                    <div class="col-6 d-lg-block flex-between-center">
                                        <h6 class="mb-2 text-900">Request Cancel</h6>
                                        <h4 class="fs-3 fw-normal text-700 mb-0">
                                            <span>0</span>
                                            <span>/</span>
                                            <span>{{ $entry_ticket }}</span>
                                    ...
                                    <div class="col-auto h-100">
                                        <img height="45" src="{{ asset('assets/img/icons/ticket_cancel.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
